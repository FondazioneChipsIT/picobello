...
## WARNING! This is an <ins>experimental branch</ins>
...
- All software targets have been disabled. All precompiled test binary are shipped with the repo. Therefore, you can ingore the compiler requirements (and the relative warnings related to their absence while running make targets).
